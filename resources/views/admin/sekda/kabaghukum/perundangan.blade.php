@foreach ($subBagHukumPerundangan as $sbhp)
   ...
   <div class="accordion-item">
       <h2 class="accordion-header" id="innerHeading-{{ $sbhp['id_opd_jabatan'] }}">
           <button class="accordion-button collapsed" type="button"
               ...
               data-bs-target="#innerCollapse-{{ $sbhp['id_opd_jabatan'] }}"
               aria-expanded="false"
               aria-controls="innerCollapse-{{ $sbhp['id_opd_jabatan'] }}">
               {{ $sbhp['nama_jabatan'] }}
           </button>
       </h2>
       <div id="innerCollapse-{{ $sbhp['id_opd_jabatan'] }}"
...
@include('admin.modals.modal-sekda-subBag-perundangan')
@endif
@endforeach
