<div class="modal fade text-left" id="modal-{{ $ksbadp['id_opd_jabatan'] }}"
        ...
        <form class="form"
            ...
            <div class="modal-body">
               <input type="text"class="form-control" name="username"
                    value="{{ $ksbadp['nip'] }}" hidden>
               <label for="nama">Kode Jabatan</label>
               <input type="text" class="form-control" name="kode_jabatan"
                     value="{{ $ksbadp['kode_jabatan'] }}" readonly>
                <label for="nama">Nama</label>
                <input type="text" class="form-control" name="name"
                    value="{{ $ksbadp['nama_pegawai'] }}" readonly>
                <label for="nip">Nip</label>
                <input type="text"class="form-control" name="nip"
                    value="{{ $ksbadp['nip'] }}" readonly>
                <label for="nip">Jabatan</label>
                <input type="text"class="form-control" name="jabatan"
                    value="{{ $ksbadp['nama_jabatan'] }}" readonly>
