<div class="modal fade text-left" id="modal-{{ $adc['id_opd_jabatan'] }}"
        ...
        <form class="form"
            ...
            <div class="modal-footer">
                <div class="col-12 d-flex justify-content-end">
                    ...
                    <button style="display: none" id="loadcng"
