<div class="modal fade text-left" id="modal-{{ $kbk['id_opd_jabatan'] }}"
            ...
            <div class="modal-footer">
                <div class="col-12 d-flex justify-content-end">
                    ...
                    <button style="display: block" id="send"
                        type="kbkmit" class="btn btn-primary">Simpan</button>
                </div>
            </div>
        </form>
    </div>
