<div class="modal fade text-left" id="modal-{{ $sba['id_opd_jabatan'] }}"
            ...
            <div class="modal-footer">
                <div class="col-12 d-flex justify-content-end">
                    ...
                    <button style="display: block" id="send"
                        type="sbamit" class="btn btn-primary">Simpan</button>
                </div>
            </div>
        </form>
    </div>
