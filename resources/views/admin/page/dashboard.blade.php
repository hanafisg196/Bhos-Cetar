                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                <h6 class="text-white font-semibold">Total Laporan Tahun Ini</h6>
                                ...
                                <div class="card" style="background:#364b98">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                <h6 class="text-white font-semibold">Total Laporan Bulan Ini</h6>
                                ...
                                <div class="card" style="background:#364b98">
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                <h6 class="text-white font-semibold">Total Laporan Minggu Ini</h6>
