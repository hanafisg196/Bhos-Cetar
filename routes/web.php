...
Route::middleware('user')->group(function () {
    ...
    Route::get('/laporan-bantuan-hukum/detail/{id}', [ScheduleController::class, 'getDataById'])->name('show.bantuan.hukum');
    Route::post('/laporan-bantuan-hukum/delete/file/{id}', [ScheduleController::class, 'deleteDokumen'])->name('delete.dokumen.bantuan.hukum');
    Route::post('/laporan-bantuan-hukum/update/{id}', [ScheduleController::class, 'update'])->name('update.bantuan.hukum');
    ...
    Route::middleware('kamiPeduliUploader')->group(function () {
        ...
        Route::get('/laporan-aksi-ham/detail/{id}', [ReportHamController::class, 'getRanham'])->name('show.aksi.ham');
        Route::post('/laporan-aksi-ham/update/{id}', [ReportHamController::class, 'update'])->name('update.aksi.ham');
    });
    ...
    Route::middleware('ecorrectionUploader')->group(function () {
        ...
        Route::get('/ecorrection/detail/{id}', [EcorrectionController::class, 'getEcorrection'])->name('show.ecorrection');
    });
    Route::middleware('admin')->group(function () {
        ...
        Route::middleware('ecorrectionAdmin')->group(function () {
            ...
            Route::get('/ecorrection/inbox/detail/{id}', [InboxController::class, 'detailEcorrection'])->name('admin.detail.ecorrection');
        });
    });
});
